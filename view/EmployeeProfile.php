<?php
  ...
  //$func = "Create";
  $userId = "";
  $userName = $fname = $lname = $fatherName = $dob = $address = $postCode = $email = $phone = $maritalStatus = $nationality = $nId = $religion = $status = $jobId = "";
  ...
  {
    global $connection, $userName, $fname, $lname, $fatherName, $dob, $address, $postCode, $email, $phone, $maritalStatus, $nationality, $nId, $religion, $status, $jobId;
  ...
  if(isset($_POST['submit']))
  {
    ...
    if($func=="Update")
    {
      ...
      $query = "UPDATE employee SET Username = '$userName', first_name = '$fname', last_name = '$lname', father_name = '$fatherName', dob = '$dob', address = '$address', postcode = '$postCode', email = '$email', phone = '$phone', ";
...
<?php include "header-admin.php"; ?>
      ...
      <table border="0" cellspacing="0" cellpadding="3">
        ...
        <tr>
          ...
          <td><input class="form-control" name="password" type="text" value="<?php// echo $password; ?>" <?php //if($func=="Read"){echo "disabled";} else{echo "required";} ?>/></td> -->
        </tr>
