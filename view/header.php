  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush" id="list">
        <a
          href="/HRMS/view/emp-profile.php"
          class="list-group-item list-group-item-action" style="background-color: #2a3f5b;">
          Profile
        </a>
        <a href="/HRMS/view/JobManagement.php" class="list-group-item list-group-item-action"style="background-color: #2a3f5b;">Jobs</a>
        <a href="/HRMS/view/emp-attendance.php" class="list-group-item list-group-item-action"style="background-color: #2a3f5b;">Attendance</a>
        <a href="/HRMS/view/emp-salary.php" class="list-group-item list-group-item-action"style="background-color: #2a3f5b;">Salary Report</a>
        ...
        <a href=# class="list-group-item list-group-item-action"style="background-color: #2a3f5b;">Applications</a>
        <a href=# class="list-group-item list-group-item-action"style="background-color: #2a3f5b;">News</a>
